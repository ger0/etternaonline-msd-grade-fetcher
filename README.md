...
If script installation doesn't prompt automatically, you can manually copy the code from the GitHub repository and create a new userscript in your greasemonkey/tampermonkey extension.
